...
void Structmesh2d::readmesh(std::string meshname)
{
	std::ifstream fin(meshname);
	fin >> imx >> jmx;
	...
	std::cout << "Structmesh2d: readmesh(): Mesh read. Points in i-dir: " << imx << ", points in j-dir: " << jmx << "." << std::endl;
}
